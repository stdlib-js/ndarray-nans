...
import { Shape, Order, Mode, typedndarray, float64ndarray, float32ndarray, float16ndarray, genericndarray, complex128ndarray, complex64ndarray, FloatingPointAndGenericDataType, Float64DataType, Float32DataType, Float16DataType, Complex128DataType, Complex64DataType, GenericDataType } from '@stdlib/types/ndarray';
...
* // returns 'float16'
*/
declare function nans( shape: Shape | number, options: Float16Options ): float16ndarray;
